...
import './KurtaMCard.css'
import KurtaMData from '../../data/KurtaMData'
import KurtaMCategory from '../../data/KurtaMCategory'
const KurtaMCard = () => {
    let [data,setdata]=useState(KurtaMData)
    let [categorydata,setcategorydata]=useState(KurtaMCategory)
  return (
    <div>
    {/* <!-- Categiry and  filter  --> */}
