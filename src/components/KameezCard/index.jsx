...
import './KameezCard.css'
import KameezData from '../../data/KameezData'
import KameezCategory from '../../data/KameezCategory'

const KameezCard = () => {
    let [data,setdata]=useState(KameezData)
    let [categorydata,setcategorydata]=useState(KameezCategory)
  return (
    <div>
    {/* <!-- Categiry and  filter  --> */}
