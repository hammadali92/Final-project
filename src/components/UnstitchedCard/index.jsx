...
import UnstitchedCategory from '../../data/UnstitchedCategory'
import UnstitchedData from '../../data/UnstitchedData'

const UnstitchedCard = () => {
    let [data,setdata]=useState(UnstitchedData)
    let [categorydata,setcategorydata]=useState(UnstitchedCategory)
  return (
    <div>
    {/* <!-- Categiry and  filter  --> */}
