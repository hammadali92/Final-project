...
import './WaiscoatCard.css'
import WaistcoatData from '../../data/WaistcoatData'
import WaiscoatCategory from '../../data/WaiscoatCategory'

const WaistcoatCard = () => {
    let [data,setdata]=useState(WaistcoatData)
    let [categorydata,setcategorydata]=useState(WaiscoatCategory)
  return (
    <div>
    {/* <!-- Categiry and  filter  --> */}
